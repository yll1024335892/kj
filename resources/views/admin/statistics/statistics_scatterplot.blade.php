            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="panel-body pos-r">
                        ...
                        <div id="echarts-operate-7-modal" style="display:none;width: 240px;background-color: #fff;padding: 20px;z-index: 9;position: absolute;top: 200px; left: 50%;margin-left: -120px;border: solid 1px #ccc;">
        ...
        function rfm(type){
            ...
            echarts1.on('brushSelected', function (params) {
                ...
                if(selectedItems.length > 0 || selectedItems2.length > 0){
                    $("#echarts-operate-7-modal").show();
                }else {
                    $("#echarts-operate-7-modal").hide();
                }
            });
